...
var Player = function Player(name, avatar, weapon) {
  var _this = this;
  ...
  _defineProperty(this, "generate", function () {
    return {
      ...
      weapon: {
        damage: 10,
        image: "<img src=\"".concat(_this.weapon, "\" />")
      }
    };
  });
...
},{"../images/player-1.png":"images/player-1.png","../images/player-2.png":"images/player-2.png","../images/weapon-1.png":"images/weapon-1.png","../images/weapon-2.png":"images/weapon-2.png"}],"js/game.js":[function(require,module,exports) {
"use strict";
...
var playerOne = new _player.default("Player1", _assets.player1, _assets.weapon1).generate();
console.log({
  playerOne: playerOne
});
...
rulesBtn.addEventListener("click", function () {
  var modal = document.querySelector("#rules-modal");
  modal.style.display = "flex";
  document.querySelector("#rules-modal button").addEventListener("click", function () {
...
createBoard();
},{"./player":"js/player.js","./assets":"js/assets.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
